...
DROP FUNCTION IF EXISTS ged2.build_study_region(numeric);
CREATE OR REPLACE FUNCTION ged2.build_study_region(
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION ged2.build_study_region(numeric)
  OWNER TO paul;
